    ...
    public function up(): void
    {
        Schema::create("orders", function (Blueprint $table) {
            ...
            $table
                ->string("va_bank")
                ->nullable()
                ->comment("bca, mandiri, bni, dll");
            $table
                ->string("payment_type")
                ->nullable()
                ->comment("bank_transfer, gopay, dll");
            $table
                ->string("transaction_status")
                ->default("pending")
                ->comment("pending, settle, expire, cancel");
            $table
                ->string("fraud_status")
                ->nullable()
                ->comment("accept, deny, challenge");
